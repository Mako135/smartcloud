      ...
      <Accordion type="single" collapsible className="w-full mt-20">
        ...
        <AccordionItem value="third">
          ...
          <AccordionContent className="grid gap-5 text-[18px]">
            ...
            <div>
              <strong  className="text-secondary">Позитивная модель:</strong> Определяет, какие действия
              разрешены на веб-сайте. Для этого создаются детальные правила,
              описывающие допустимые запросы, ответы и поведение пользователей.
              Такая модель обеспечивает высокую точность, но требует
              значительных затрат времени на обучение и настройку.
            </div>{" "}
            <div>
              <strong  className="text-secondary">Отрицательная модель:</strong> Определяет, какие действия
              запрещены. В этой модели создается список известных атак и
              уязвимостей, которые блокируются по умолчанию. Такая модель
              позволяет быстро развернуть защиту и не требует длительной
              настройки.
            </div>
            <div>
